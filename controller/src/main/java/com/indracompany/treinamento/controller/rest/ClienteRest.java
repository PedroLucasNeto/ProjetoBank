...
public class ClienteRest extends GenericCrudRest<Cliente, Long, ClienteService>{
	...
	/*@PostMapping(value = "/criaCliente/") 
	public ResponseEntity<Cliente> criaCliente(@RequestBody Cliente novoCliente){
		Cliente cliente = clienteService.criaClienteComConta(novoCliente);
		if(clienteService.buscarClientePorCpf(novoCliente.getCpf())!=null) {
