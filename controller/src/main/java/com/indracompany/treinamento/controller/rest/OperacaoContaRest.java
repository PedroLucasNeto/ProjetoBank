...
public class OperacaoContaRest extends GenericCrudRest<OperacaoConta, Long, OperacaoContaService> {
	...
	public @ResponseBody ResponseEntity<List<OperacaoContaDTO>> listaExtratoPorDataEConta(
		...
		List<OperacaoContaDTO> listaDeExtratos = operacaoContaService.listaExtratoDoCliente(dataInicio, dataFim,
				agencia, numero);
	...
	// Para a consulta ser exata digitar data e hora na requisição. EXEMPLO : de
	// 13/09/2022 10:16:50 a 16/09/2022 10:17:00
	...
	public @ResponseBody ResponseEntity<List<OperacaoContaDTO>> listaExtratosEntreDatas(
		...
		List<OperacaoContaDTO> listaDeExtratosPorData = operacaoContaService.listaTodosExtratos(dataInicio, dataFim);
